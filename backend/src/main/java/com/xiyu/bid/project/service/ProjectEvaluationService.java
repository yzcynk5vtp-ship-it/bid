...
public class ProjectEvaluationService {
    ...
    private EvaluationDTO toDto(ProjectEvaluation e) {
        ...
        // 判断评标阶段是否已完成
        ProjectStage currentStage = projectStageService.currentStage(e.getProjectId());
        boolean done = currentStage != ProjectStage.EVALUATING && currentStage != ProjectStage.DRAFTING;
