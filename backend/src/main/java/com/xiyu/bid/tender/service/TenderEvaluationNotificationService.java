...
// Output: TODO task creation + notification center + WeCom for reviewers and status-change-only for creator
// Pos: Service/标讯评估通知外壳
// 维护声明: REQ-BC-010 通知逻辑统一在此，TenderEvaluationSubmissionService.submit() 委托本类执行.
// 2026-06 更新: 审核通知 → 投标管理员+投标组长(TODO+通知中心+企微)；状态变更提醒 → 创建人(仅通知中心).
 ...
 * <p>提交后：
 * <ul>
 *   <li>投标管理员 + 投标组长 → TODO（审核）+ 通知中心 + 企微推送</li>
...
public class TenderEvaluationNotificationService {
    ...
    private static final Set<String> REVIEWER_ROLES = Set.of("admin", "bid_admin", "bid_lead");
