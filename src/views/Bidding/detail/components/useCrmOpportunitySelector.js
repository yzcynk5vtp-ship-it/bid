      ...
      emit('linked', {
        ...
        evaluationData: {
          opportunityId: null, basic: {
            riskAssessment: mf.remark || '', competitorAnalysis: '',
            contractPeriodStart: mf.evaluationTime || '', contractPeriodEnd: '',
            shortlistedCount: 0, platformServiceFee: 0, ecommerceMroAmount: 0, planSupplierCount: 0,
            bidDocumentDisadvantage: '', riskPrediction: '', contingencyPlan: '',
            processKnowledge: '', supportNotes: '', projectPlanGap: '', customerRevenue: null,
          },
    ...
    emit('linked', {
      ...
      evaluationData: {
        ...
        basic: {
          ...
          ecommerceMroAmount: chance.ecommerceMroAmount || 0,
