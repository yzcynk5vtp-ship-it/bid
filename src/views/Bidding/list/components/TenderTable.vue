<template>
  <div class="table-container">
    ...
    >
      ...
      <!-- 总部所在地 -->
      <el-table-column prop="region" label="总部所在地" width="90" align="center" show-overflow-tooltip>
        <template #default="{ row = {} } = {}">{{ row.region || '-' }}</template>
      </el-table-column>

      <!-- 招标主体 -->
      <el-table-column prop="purchaserName" label="招标主体" width="140" show-overflow-tooltip>
      ...
      <!-- 报名截止日期 -->
      <el-table-column prop="registrationDeadline" label="报名截止日期" width="140" align="center">
        <template #default="{ row = {} } = {}">
          <span
            class="date-cell"
            :class="{
      ...
      <!-- 标讯状态 -->
      <el-table-column prop="status" label="标讯状态" width="95" align="center">
        <template #default="{ row = {} } = {}">
