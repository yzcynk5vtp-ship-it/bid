<template>
  <div class="table-container">
    ...
    >
      ...
      <!-- 总部所在地 -->
      <el-table-column prop="region" label="总部所在地" width="130" align="center" show-overflow-tooltip>
        <template #default="{ row = {} } = {}">{{ row.region || '-' }}</template>
      </el-table-column>

      <!-- 招标主体 -->
      <el-table-column prop="purchaserName" label="招标主体" width="150" show-overflow-tooltip>
