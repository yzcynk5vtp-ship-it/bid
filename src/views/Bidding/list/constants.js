...
export const SOURCE_FILTER_OPTIONS = SOURCE_PLATFORM_OPTIONS
...
export const SOURCE_OPTIONS = [
  { label: EXTERNAL_PLATFORM_SOURCE_LABEL, value: 'EXTERNAL_PLATFORM' },
  { label: CRM_SOURCE_LABEL, value: 'CRM_OPPORTUNITY' },
  { label: MANUAL_SOURCE_LABEL, value: 'MANUAL_SINGLE' },
